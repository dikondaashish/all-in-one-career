...
export default function LandingPage() {
  ...
  const [firebaseConfigStatus, setFirebaseConfigStatus] = useState<'checking' | 'configured' | 'missing'>('checking');
  ...
  useEffect(() => {
    const checkFirebaseConfig = () => {
      ...
      if (missingVars.length > 0) {
        ...
        console.error('Firebase configuration incomplete. Missing:', missingVars);
      } else {
      ...
      <div className="w-[58%] bg-white flex items-center justify-center px-16">
        <div className="w-full max-w-md">
            ...
            <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-3 rounded-lg text-sm mb-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="mt-1">Please set up your Firebase environment variables. Check the SETUP_FIREBASE.md file for instructions.</p>
                </div>
              </div>
            </div>
          )}

          {firebaseConfigStatus === 'configured' && (
            <div className="bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-lg text-sm mb-6">
              <div className="flex items-center">
                ...
                <span>Firebase is properly configured</span>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading || firebaseConfigStatus === 'missing'}
          ...
          <button
            ...
            disabled={isLoading || firebaseConfigStatus === 'missing'}
            className="w-full h-12 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
          >
          ...
          {firebaseConfigStatus === 'missing' && (
            <div className="mt-4 text-center">
              <p className="text-sm text-gray-600 mb-2">
                To enable login functionality, you need to configure Firebase:
              </p>
              <ol className="text-xs text-gray-500 text-left space-y-1">
                <li>1. Create a Firebase project at <a href="https://console.firebase.google.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">console.firebase.google.com</a></li>
                <li>2. Enable Google Authentication</li>
                <li>3. Create a .env.local file with your Firebase config</li>
                <li>4. See SETUP_FIREBASE.md for detailed instructions</li>
              </ol>
            </div>
          )}
