...
export default function Topbar({ sidebarCollapsed, onToggleSidebar }: TopbarProps) {
  ...
  return (
    <>
      ...
      {isFallbackAuth() && (
        <div className="fixed top-0 left-0 right-0 bg-yellow-500 text-yellow-900 px-4 py-2 text-sm font-medium z-50 flex items-center justify-between">
      ...
      <div className={`fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-40 ${isFallbackAuth() ? 'top-10' : ''}`}>
        <div className="flex items-center justify-between h-full px-6">
